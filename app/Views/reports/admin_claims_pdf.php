...
<body>
      ...
      <?php else: ?>
        <?php foreach ($rows as $row): ?>
          <tr>
            ...
            <td class="text-end"><?= esc($row['cashless'] ?? '0.00') ?></td>
            <td class="text-end"><?= esc($row['copay'] ?? '0.00') ?></td>
            <td class="text-end"><?= esc($row['non_payable'] ?? '0.00') ?></td>
  ...
  <table class="totals">
    <tbody>
      ...
      <tr>
        <td class="label">Total non-payable:</td>
        <td class="text-end">₹<?= esc($totals['non_payable'] ?? '0.00') ?></td>
      </tr>
    </tbody>
  </table>
</body>
